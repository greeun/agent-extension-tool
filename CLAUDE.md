...
FEATURES.md             → Feature inventory (41 subcommands, 3 main TUI tabs: Extensions/Context/Usage)
...
| `axt mcp` | MCP server list / info / enable / disable |
| `axt hook` | Hook list / enable / disable |
